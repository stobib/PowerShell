...
This function will pause long output every half second for easier readability.
You can change the -seconds modifier to milliseconds or adjest interval as necessary.
