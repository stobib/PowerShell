...
#Get-Cluster -name "ARDC PROD-DEV" |Get-VM | Select Name, PowerState | sort Name | Export-Csv -path “c:\pwscriptoutputs\inventory\vminventory-$date.csv” –NoTypeInformation
#Get-VM | Select Name, PowerState, OSFullName | sort Name | Export-Csv -path “c:\pwscriptoutputs\inventory\vminventory-$date.csv” –NoTypeInformation
Get-VM |Get-VMGuest | Select VmName, State, OSFullName | sort Name | Export-Csv -path “c:\pwscriptoutputs\inventory\vminventory-$date.csv” –NoTypeInformation