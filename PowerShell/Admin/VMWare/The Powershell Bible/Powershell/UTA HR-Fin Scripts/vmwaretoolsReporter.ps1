...
Get-VM | Select Name, PowerState | sort Name | Export-Csv -path “c:\pwscriptoutputs\inventory\vminventory.csv” –NoTypeInformation

$computers = Import-Csv -Path “c:\pwscriptoutputs\inventory\vminventory.csv”
