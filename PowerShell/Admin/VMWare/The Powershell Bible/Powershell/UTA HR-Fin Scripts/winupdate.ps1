...
# EMAIL: alin.dumenica@danone.com
#
...
#          http://windows-scripting.co.cc/tutorials/install-windows-updates-windows-powershell
#
...
$EmailReport = $true
$FileReport = $false
$To = "IT-Reports@domain.local"
$From = "updatesinstalledreport@domain.local"
$SMTPServer = "your smtp server"
$FileReportPath = "\\server\share\"
$AutoRestart = $false
...
"Invoke-WindowsUpdate was run on $env:ComputerName, and the server $status `Please run Invoke-WindowsUpdate again when the server is rebooted." | Out-File -FilePath $path
}
