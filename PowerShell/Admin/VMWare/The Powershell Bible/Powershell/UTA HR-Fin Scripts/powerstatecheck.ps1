...
$filepath = Read-OpenFileDialog -WindowTitle "Select Text File" -InitialDirectory 'C:\' -Filter "Text files (*.csv)|*.csv"
...
Get-VM -name $computer | Select Name, PowerState | sort Name | ExpoDert-Csv -Append -path “c:\pwscriptoutputs\inventory\vmpowerstate-$date.csv” –NoTypeInformation
}