...
Get-VM | Select Name, PowerState, Host, @{N="IPAddress"; E={$_.Guest.IPAddress[0]}} | sort Name | Export-Csv -path “c:\pwscriptoutputs\inventory\vminventory-$date.csv” –NoTypeInformation