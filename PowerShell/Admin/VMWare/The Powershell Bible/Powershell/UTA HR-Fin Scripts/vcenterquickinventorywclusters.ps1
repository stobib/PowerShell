...
Get-Cluster -name NON,NRP,PRD |Get-VM |Get-VMGuest | Select VmName, State, OSFullName | sort Name | Export-Csv -path “C:\Users\sy1001130585\Desktop\PowershellOutput\inventory\vminventory-$date.csv” –NoTypeInformation