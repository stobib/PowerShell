...
Write-Host
Write-Host 'Enter 6 to Shutdown Tier 6 VMs'
Write-Host
Write-Host 'Enter 7 to Shutdown Tier 7 VMs'
Write-Host
Write-Host 'Enter 8 to Shutdown Tier 8 VMs'
Write-Host
Write-Host 'Enter 9 to Shutdown Tier 9 VMs'
Write-Host
...
elseif ($RunType -eq "6"){
	...
	WriteLog "You have chosen to shutdown Tier 6 VMs"
...
elseif ($RunType -eq "7"){
	#Create the input file, which lists the Physical Servers by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the shutdownPhysicalServers routine with the correct filename
	WriteLog "You have chosen to shutdown Tier 7 VMs"
...
elseif ($RunType -eq "8"){
	#Create the input file, which lists the Physical Servers by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the shutdownPhysicalServers routine with the correct filename
	WriteLog "You have chosen to shutdown Tier 8 VMs"
...
elseif ($RunType -eq "9"){
	#Create the input file, which lists the Physical Servers by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the shutdownPhysicalServers routine with the correct filename
	WriteLog "You have chosen to shutdown Tier 9 VMs"
