...
$StartupTier6Filename = ".\StartupTier6VMs.csv"
$StartupTier7Filename = ".\StartupTier7VMs.csv"
$StartupTier8Filename = ".\StartupTier8VMs.csv"
$StartupTier9Filename = ".\StartupTier9VMs.csv"
...
Write-Host
Write-Host "Enter 5 to Start Up Tier 5 VMs"
Write-Host
Write-Host "Enter 6 to Start Up Tier 6 VMs"
Write-Host
Write-Host "Enter 7 to Start Up Tier 7 VMs"
Write-Host
Write-Host "Enter 8 to Start Up Tier 8 VMs"
Write-Host
Write-Host "Enter 9 to Start Up Tier 9 VMs"
Write-Host
...
elseif ($RunType -eq "6"){
	#Create the input file, which lists the vm's by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the StartupVM's routine with the correct filename
	WriteLog "You have chosen to Startup Tier 6 VMs"
	$inputfile = get-content (Join-Path $scriptDir $StartupTier6Filename)
	StartupRoutine ($inputfile)
}
elseif ($RunType -eq "7"){
	#Create the input file, which lists the vm's by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the StartupVM's routine with the correct filename
	WriteLog "You have chosen to Startup Tier 7 VMs"
	$inputfile = get-content (Join-Path $scriptDir $StartupTier7Filename)
	StartupRoutine ($inputfile)
}
elseif ($RunType -eq "8"){
	#Create the input file, which lists the vm's by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the StartupVM's routine with the correct filename
	WriteLog "You have chosen to Startup Tier 8 VMs"
	$inputfile = get-content (Join-Path $scriptDir $StartupTier8Filename)
	StartupRoutine ($inputfile)
}
elseif ($RunType -eq "9"){
	#Create the input file, which lists the vm's by stitching together the current directory of the script 
	#and the name of the filename with the list of vm's. Call the StartupVM's routine with the correct filename
	WriteLog "You have chosen to Startup Tier 9 VMs"
	$inputfile = get-content (Join-Path $scriptDir $StartupTier9Filename)
	StartupRoutine ($inputfile)
}
else {
	WriteLog
