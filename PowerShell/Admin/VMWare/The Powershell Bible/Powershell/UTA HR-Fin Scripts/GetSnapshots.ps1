...
#Make sure VMware Snapin has been loaded
...
#get-vm | get-snapshot | Select VM, Name, Description,SizeGB,Created |Where {$_.Description -lt (Get-Date)} | Write-Output

#Write-Host $mylist



get-vm | get-snapshot |Sort-Object created|format-list created,vm,name,sizeGB,Description | out-file "C:\snaps.txt"


# Where-Object {$_.extensiondata.escription -contains 'dgrays-uta'}|