...
Elevate-Process -Exe powershell.exe -Arguments "-noninteractive -command C:\Windows\snmpinstall.ps1"
'



#$cmd='"powershell.exe -ExecutionPolicy Bypass -file C:\Users\sy1001130585\Desktop\testsnmpinstall.ps1"'
#$cmd='"Invoke-Command -ComputerName localhost -Filepath C:\Users\sy1001130585\Desktop\testsnmpinstall.ps1"'
$Fullpath = "C:\Users\sy1001130585\Desktop\snmpinstall.ps1"
$DstPath = "C:\Windows"
$Cred = Get-Credential
$rmcmd="Remove-Item -Path C:\Windows\snmpinstall.ps1"
#Get-VM -Name "dca02" | Where{$_.Guest.OSFullName -match '2012'}|Invoke-VMScript -ScriptText $cmd -ScriptType Powershell 

$Servers = Get-Content C:\Users\sy1001130585\Desktop\testwindowshostips.txt
foreach ($Server in $Servers){

Copy-VMGuestFile -VM $Server -Source $Fullpath -Destination $DstPath -LocalToGuest -GuestCredential $Cred -Force
Invoke-VMScript -VM $Server -ScriptText $script -ScriptType Powershell -GuestCredential $Cred
#Invoke-Command -ComputerName $Server -Filepath C:\Users\sy1001130585\Desktop\testsnmpinstall.ps1
Start-Sleep -s 5
Invoke-VMScript -VM $Server -ScriptText $rmcmd -ScriptType Powershell -GuestCredential $Cred
}
