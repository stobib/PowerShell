ConfigMgr Client Health Version: 0.8.1
...
Note: Script version 0.8.1 requires database version 0.7.5. Execute query in CreateDatabase.sql to create or update the database.
