...
RunClientAction -Computername (Get-Content .\VMExport\InputFile.txt) -ClientAction 'HardwareInventory','SoftwareInventory','ScanbyUpdateSource','SoftwareUpdatesAssignmentsEvaluationCycle'