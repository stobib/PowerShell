...
param(
    ...
    [parameter(ValueFromPipeline=$true,ValueFromPipelineByPropertyName=$true)][string]$ImportLogFile,
...
$DefaultParameterValues=@{"ImportLogFile"="Missing_IP_"}
If!($ImportLogFile){$ImportLogFile+=($DefaultParameterValues.ImportLogFile)}
...
$Script:CurrentProcessFile=($ImportLogFile+$LogDate+".log")
