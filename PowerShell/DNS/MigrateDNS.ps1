...
Set-Variable -Name Destination -Value ($env:SystemRoot+"\System32\DNS")
ForEach($GC In $AllDCs){
    ...
    <#
    # Export existing zones of the utshare.local domain from dca01.
    dnscmd /zoneexport "<your zone name>" "<zone file name>"

    # Import existing zones of the utshare.local domain to w19dnsasz01.
